...
namespace ArctiumStudios.SplineTools
{
    ...
    [GeneratorMenu(menu = "SplineTools/Map",
        ...
        helpLink = "https://gitlab.com/Mnlk/mapmagic-spline-tools/wikis/generators/map/flatten_plus_v2")]
    public class FlattenPlusV2Generator : Generator, IInlet<MatrixWorld>, IMultiInlet, IOutlet<MatrixWorld>
    {
        ...
        public override void Generate(TileData tileData, StopToken stop)
        {
            ...
            if (!enabled || stop != null && stop.stop || MandatoryInputMissing(inputNodes, this) || nodesByOffset == null || heights == null)
            {
            ...
            var maxRadius = SplineTools.Instance.GlobalMaxRadius();
